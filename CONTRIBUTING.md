Contributing to Mangaka Core
============================

The Mangaka Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Mangaka Core project, and is not to be
confused with overall Mangaka Network Protocol consensus changes.

Whether a pull request is merged into Mangaka Core rests with the project merge
...
Patches that change Mangaka consensus rules are considerably more involved than
...
Where a patch set proposes to change the Mangaka consensus, it must have been
...
The project leader is the release manager for each Mangaka Core release.
