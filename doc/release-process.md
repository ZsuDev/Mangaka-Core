...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/mangakacoin/mangakacoin.git
...
### Build and sign Mangaka Core for Linux, Windows, and OS X:
    ...
    ./bin/gbuild --memory 3000 --commit mangaka=v${VERSION} ../mangaka/contrib/gitian-descriptors/gitian-win.yml
...
- Detached signatures will then be committed to the [mangaka-detached-sigs](https://github.com/mangakacoin/mangaka-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
space *do not upload these to the mangaka.com server*.
