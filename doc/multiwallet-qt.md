...
In order to support loading of multiple wallets in mangaka-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is mangaka.cpp.
...
Changes to mangaka.cpp
----------------------
mangaka.cpp is the entry point into mangaka-qt, and as such, will require some minor modifications to provide hooks for
