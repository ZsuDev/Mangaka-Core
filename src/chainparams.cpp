...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    ( 200, uint256("0x00000031f3d042b80c7e0430a8ada71e7f9886868e83028115cdab15bd9952c7"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1526129953, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1525963590;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 21151226;
...
public:
    CTestNetParams()
    {
        ...
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000004c68d6fc4e5f4a629bfe7c8f548b6cf1fc2ca1bd5d25c219a4b907b0ace"));
        vFixedSeeds.clear();
        vSeeds.clear();
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet mangaka addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet mangaka script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet mangaka BIP32 pubkeys start with 'DRKV'
...
public:
    CRegTestParams()
    {
        ...
        nTargetSpacing = 1 * 60;        // Mangaka: 1 minutes
