...
/** Utility functions used by the Mangaka Qt UI.
 */
namespace GUIUtil
{
...
// Render Mangaka addresses in monospace font
...
// Parse "mangaka:" URI into recipient object, return true on successful parsing
