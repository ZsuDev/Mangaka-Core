...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Mangaka Core mangaka-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  mangaka-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mangaka transaction") + "\n" +
                               "  mangaka-tx [options] -create [commands]   " + _("Create hex-encoded mangaka transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded mangaka transaction
