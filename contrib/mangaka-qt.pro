...
RESOURCES += src/qt/mangaka.qrc src/qt/mangaka_locale.qrc

TRANSLATIONS += src/qt/locale/mangaka_bg.ts \
                src/qt/locale/mangaka_de.ts \
                src/qt/locale/mangaka_en.ts \
                src/qt/locale/mangaka_es.ts \
                src/qt/locale/mangaka_fi.ts \
                src/qt/locale/mangaka_fr.ts \
                src/qt/locale/mangaka_it.ts \
                src/qt/locale/mangaka_ja.ts \
                src/qt/locale/mangaka_pl.ts \
                src/qt/locale/mangaka_pt.ts \
                src/qt/locale/mangaka_ru.ts \
                src/qt/locale/mangaka_sk.ts \
                src/qt/locale/mangaka_sv.ts \
                src/qt/locale/mangaka_vi.ts \
                src/qt/locale/mangaka_zh_CN.ts \
                src/qt/locale/mangaka_zh_TW.ts
